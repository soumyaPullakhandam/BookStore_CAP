...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "authorslistview/test/integration/AuthorsListJourney.gen",
    "authorslistview/test/integration/AuthorsObjectPageJourney.gen",
    "authorslistview/test/integration/BooksObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
